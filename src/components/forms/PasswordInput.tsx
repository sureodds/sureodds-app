    ...
    <div className="mb-4">
      ...
      <div className="relative">
        <input
          ...
          className={`w-full px-4 sm:py-3 py-2 sm:text-md text-sm border border-primary rounded-md shadow-sm text-zinc-900 bg-transparent focus:outline-none focus:border-main ${
